...
const ShoeCard = ({ imgURL, changeBigShoeImage, bigSheoImg }) => {
    const handleClick = () => {
    ...
    return (
        ...
        ${bigSheoImg === imgURL.bigShoe ? 'border-coral-red' : 'border-transparent'} cursor-pointer max-sm:flex-1`} onClick={handleClick}>
